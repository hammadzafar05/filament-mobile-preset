...
This does rely on browsers honouring the last viewport tag when several are present — universally
implemented, though not formally specified. A script patching the existing tag would have been
